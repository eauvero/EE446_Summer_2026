...
* `data_prep`: Python scripts to extract and preprocess images from the Kaggle GazeCapture and MPIIFaceGaze datasets.

* `demo`: Arduino and Python code for the Face Gaze Tracker demo.
